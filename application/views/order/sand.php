<div class="flex_row"> <!-- вторая горизонтальная линия -->
	<div class="Choise_marka_concrete  col-md-4" >
		<h2 style="text-align:center">1.Выберите вид песка:</h2>
		<div class="form-group">
			<select class="form-control">
				<option value="Промышленный"> Промышленный песок</option>
				<option value="Карьерный"> Карьерный песок</option>
			</select>
		</div>
	</div>
...
<div class="flex_row"> <!-- третья горизонтальная линия -->
		...
		<div class="col-md-4">
			...
			<p> Пункт доставки: <br><input type="text" name="delivery_point" ></p>
			<p> Итого получаем:
					<p> Количество машин <br><input type="text" name="count_car" ></p>
...
<script type="text/javascript">
    ...
    function init(){     
		...
		//    
		myPlacemark = new ymaps.Placemark([52.702884, 39.417637], { 
            hintContent: 'Пункт А', 
            balloonContent: 'Песок' 
        });
